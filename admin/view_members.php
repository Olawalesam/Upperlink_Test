...
$sql = "SELECT * FROM registration ORDER BY id DESC LIMIT $startrow, 10";
...
<div id="main_container">
  ...
  <div class="header">
    ...
    <div class="right_content">            
      ...
      <h2 align="center">View Registered Members </h2>
...
?>
      ...
      <center>
        <table width="606" border="2" bordercolor="#000000">
          <tr>
            <th width="61" bgcolor="#6699CC"><span class="style26">Date registered</span></th>
            <th width="52" bgcolor="#6699CC"><span class="style26">Full Name</span></th>
			<th width="61" bgcolor="#6699CC"><span class="style26">Sex</span></th>
  ...
  while ($f = mysql_fetch_array($filelist)) {
    ?>
          <tr valign="top" bgcolor="#CCCCCC">
			...
			<td bgcolor="#66CCFF"><?php echo $f['sex']; ?> </td>
