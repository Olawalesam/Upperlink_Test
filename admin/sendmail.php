...
<div id="main_container">
  ...
  <div class="header">
    ...
    <h2> Send Bulk Mails </h2>
    <div class="large-12 columns"> Welcome 
        <hr/>
      Recipients ( <?php echo $total_recipient; ?> )
  <hr/>
  <p><?php echo"$emails"; ?>&nbsp;</p>
  <hr/>
  <form name="form1" id="form1" method="post" action="process_bulk_mail.php" enctype="multipart/form-data">
    <input name="recipients" type="hidden" value="<?php echo"$emails"; ?>" />
    <input name="subject" type="text" value="subject" onFocus="if(this.value=='subject'){this.value=''};" onBlur="if(this.value==''){this.value='subject'};"/>
    <textarea class="textarea" name="message" id="message" placeholder="Enter text ..." style="width:100%; max-width: 810px; height: 200px"></textarea>
    <hr/>
    Attach Your File
    <input name="attachment" type="file" />
    <hr/>
    <button type="submit" class="success button radius">Send mails </button>
  </form>
    </div>
    <p align="center">&nbsp;</p>
    <p>&nbsp;</p>
