...
$sql = "SELECT * FROM contact ORDER BY id DESC LIMIT $startrow, 10";
...
?>
      ...
      <br />
      <center>
        <table width="611" border="2" bordercolor="#000000">
          <tr>
            <th width="89" bgcolor="#6699CC"><span class="style26">Date </span></th>
            <th width="89" bgcolor="#6699CC"><span class="style26">Name </span></th>
            <th width="138" bgcolor="#6699CC"><span class="style26">Email</span></th>
            <th width="237" bgcolor="#6699CC"><span class="style26">Comment </span></th>
...
if (mysql_num_rows($filelist) > 0) {
  while ($f = mysql_fetch_array($filelist)) {
    ?>
          <tr valign="top" bgcolor="#CCCCCC">
            ...
            <td bgcolor="#66CCFF"><?php echo $f['name']; ?> </td>
            <td bgcolor="#66CCFF"><?php echo $f['email']; ?> </td>
            <td bgcolor="#66CCFF"><?php echo $f['message']; ?> </td>
  ...
  ?>
          <tr bgcolor="#000000">
            <td><font color="red" size="3"><b>No Files! </b></font></td>
          </tr>
          <?php
}
?>
