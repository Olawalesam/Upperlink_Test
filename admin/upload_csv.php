...
<div id="main_container">
  ...
  <div class="header">
    ...
    <h2> Upload CSV File <br />
      <br />
    </h2>
    <div class="large-12 columns">
      <p>Browse For Your CSV File and Upload it.</p>
      <p>&nbsp; </p>
      <form name="form1" id="form1" method="post" action="process_csv.php" enctype="multipart/form-data">
          <hr/>
          Your CSV File
          <input name="file" type="file" />
          <hr/>
          <input name="submit" type="submit" id="submit" value="Upload CSV File" />
        </form>
    </div>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
