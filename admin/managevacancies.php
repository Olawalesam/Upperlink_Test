...
<div id="main_container">
  ...
  <div class="header">
    ...
    <div class="right_content">            
      ...
      <h2 align="center">Manage Vacancies </h2>
      <p align="center"><a href="postvacancies.php">Click Here To Upload Vacancies </a></p>
...
?>
      ...
      <table width="674" height="23" border="1" align="center">
        <tr>
          <td width="210" bgcolor="#0099FF"><div align="center"><span class="style20">Job Image</span></div></td>
          <td width="140" bgcolor="#0099FF"><div align="center"><span class="style20">Date Posted </span></div></td>
          <td width="170" bgcolor="#0099FF"><div align="center"><span class="style20">Job Designation </span></div></td>
          <td width="170" bgcolor="#0099FF"><div align="center"><span class="style20">Location </span></div></td>
          <td width="170" bgcolor="#0099FF"><div align="center"><span class="style20">Industry </span></div></td>
          <td width="170" bgcolor="#0099FF"><div align="center"><span class="style20">Start Date</span></div></td>
          <td width="170" bgcolor="#0099FF"><div align="center"><span class="style20">Salary </span></div></td>
          <td width="170" bgcolor="#0099FF"><div align="center"><span class="style20">Closing Date</span></div></td>
          <td width="170" bgcolor="#0099FF"><div align="center"><span class="style20">Work Experience </span></div></td>
          <td width="170" bgcolor="#0099FF"><div align="center"><span class="style20">Skill </span></div></td>
          ...
          <td width="91" bgcolor="#0099FF"><div align="center"><span class="style20">Delete</span></div></td>
		    <td width="91" bgcolor="#0099FF"><div align="center"><span class="style20">Archive</span></div></td>
        </tr>
        <?php
$dbcnx = @$proven;
if (!$dbcnx) {
...
//$id = $_GET['id'];
$pages = @mysql_query(
    "SELECT * FROM postvacancy ORDER BY id DESC LIMIT $startrow, 3");
if (!$pages) {
...
if($job_desig){
  echo '<tr ><td align=center>'. '<img src='. '"'.$filename . '"' .'height=40 width=40> </td>';
   echo( '<td>' . $date . '</td>');
 echo( '<td>' . $job_desig . '</td>');
  echo( '<td>' . $location . '</td>');
  echo( '<td>' . $job_sector . '</td>');
  echo( '<td>' . $start_date . '</td>');
  echo( '<td>' . $salary  . '</td>');
  echo( '<td>' . $closing_date . '</td>');
  echo( '<td>' . $work_experience . '</td>');
  echo( '<td>' . $skill . '</td>');
 echo( '<td><a href= ' . '"' . 'edit_vacancy.php?id='. $id . '"' . '><img src="images/edit.jpeg"></a></td>');
 echo( '<td><a href='. '"' . 'delete_vacancy.php?id=' . $id . '"'.  'onclick=' .'"' ."return confirm('Delete this Vacancy?')" .';'.'"'. '><img src="images/delete3.jpg"></a></td>');
  echo( '<td><a href='. '"' . 'archive_vacancy.php?id=' . $id . '"'.  'onclick=' .'"' ."return confirm('Archive this Vacancy?')" .';'.'"'. '>Send to Archive</a></td></tr>');
 ...
 echo( '<td>' . $job_desig . '</td>');
  ...
  echo( '<td>' . $work_experience . '</td>');
  echo( '<td>' . $skill . '</td>');
 echo( '<td><a href= ' . '"' . 'edit_vacancy.php?id='. $id . '"' . '>Edit</a></td>');
 echo( '<td><a href='. '"' . 'delete_vacancy.php?id=' . $id . '"'.  'onclick=' .'"' ."return confirm('Delete this Vacancy?')" .';'.'"'. '>Delete</a></td></tr>');
  echo( '<td><a href='. '"' . 'archive_vacancy.php?id=' . $id . '"'.  'onclick=' .'"' ."return confirm('Archive this Vacancy?')" .';'.'"'. '>Send to Archive</a></td></tr>');
