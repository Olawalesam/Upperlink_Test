...
mysql_select_db($database_proven, $proven);
	...
	if (isset($_GET['fullid']))
	
	{
	
	$msg_id = $_GET['fullid'];
	$_SESSION['message_id']= $msg_id ;
...
$query_proven = "SELECT * FROM letters where id='$message_id'";
...
<div id="main_container">
  ...
  <div class="header">
    ...
    <h2> Newsletters Message in Full <br />
      <br />
      <a href="view_newsletters.php">[Back]</a></h2>
    <div align="center">
    ...
    <center>
      <table width="462" border="0" bordercolor="#993333" bgcolor="#000000">
        <tr>
		  ...
		  <td bgcolor="#6699CC" class="style17"><div align="center">Message in Full</div></td>
		...
		//$the_message = substr($the_message,0,50) ;
		  ...
		  echo '<font color="white">' . $the_message .'</font>'; ?></td>
