...
<div id="main_container">
  ...
  <div class="header">
    ...
    <div class="right_content">            
      ...
      <h2 align="center"><span class="style31">EDIT VACANCY </span></h2>
      <p align="center"><a href="managevacancies.php">[Back To Manage Vacancy]</a></p>
      <center>
        <?php
$dbcnx = @$proven;
if (!$dbcnx) {
...
// otherwise, it's OK to insert the details into the database
  ...
  $sql = "UPDATE postvacancy SET date='$date',day='$day', month_posted='$month_posted',job_desig='$job_desig',location='$location', job_sector='$job_sector',start_date='$start_date', salary='$salary',closing_date='$closing_date',work_experience='$work_experience',skill='$skill',job_description='$job_description', photoname='$file',filename ='$pathname' WHERE id='$id'";
if ( @mysql_query($sql)) {
echo('<font color="red"><center><h3> you have successfully updated the Job Vacancy.</h3></center></font>');

header ("Location: managevacancies.php");
}

else {
    echo '<p>Error updating Vacancy ' .
        mysql_error() . '</p>';
...
// }
  ...
  $id = $_GET['id'];
  $row = @mysql_query("SELECT * FROM postvacancy WHERE id='$id'");
  if (!$row) {
    exit('<p>Error fetching vacancy: ' .
        mysql_error() . '</p>');
  }
...
$job_sector_retrieved = $row['job_sector'] ;
...
?>
      ...
      <form action="" method="post" enctype="multipart/form-data" name="uploadImage" id="uploadImage">
        <table width="619" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#999999" bgcolor="#6699FF">
          <tr bgcolor="#EFEFEF">
            <td colspan="2" bordercolor="#000000" bgcolor="#66CCFF" class="style20"><div align="center" class="style21 style22">UPDATE THE DETAILS FOR JOB VACANCY</div></td>
          </tr>
          <tr>
            <td width="256" bordercolor="#000000" bgcolor="#66CCFF" class="style16"><span class="style26"><strong>TODAY'S DATE</strong></span></td>
            <?php $today = date("l, F dS Y.");  ?>
            <td width="328" bordercolor="#000000" bgcolor="#66CCFF" class="style20"><input name="date" type="text" id="date" value ="<?php echo $today; ?>" readonly="yes" size="40" /></td>
          </tr>
          <tr>
            <td bordercolor="#000000" bgcolor="#66CCFF" class="style23" >JOB DESIGNATION </td>
            <td bordercolor="#000000" bgcolor="#66CCFF" class="style20"><span class="style26">
              <label>
              <input name="job_desig" type="text" id="job_desig"  value ="<?php echo $job_desig; ?>"  size="40" />
              </label>
            </span></td>
          </tr>
          <tr>
            <td bordercolor="#000000" bgcolor="#66CCFF" class="style23">LOCATION</td>
            <td bordercolor="#000000" bgcolor="#66CCFF" class="style26"><input name="location" type="text" id="location" value ="<?php echo $location; ?>" size="40" /></td>
          </tr>
          <tr>
            <td bordercolor="#000000" bgcolor="#66CCFF" class="style23">JOB INDUSTRY </td>
            <td bordercolor="#000000" bgcolor="#66CCFF" class="style26"><span class="style28" style="color: #FFFFFF; font-weight: bold">
              <select name="job_sector" id="job_sector">
			  <option  selected="selected" value="<?php echo $job_sector_retrieved; ?>"><?php echo $job_sector_retrieved; ?></option>
                <option  value="sector">-Select Job Sector- </option>
          ...
          <tr>
            ...
            <td bordercolor="#000000" bgcolor="#66CCFF" class="style26"><input name="start_date" type="text" id="start_date" value ="<?php echo $start_date; ?>" size="40" /></td>
          </tr>
          <tr>
            <td bordercolor="#000000" bgcolor="#66CCFF" class="style23">SALARY</td>
            <td bordercolor="#000000" bgcolor="#66CCFF" class="style26"><input name="salary" type="text" id="salary" value ="<?php echo $salary; ?>"  size="40" /></td>
          </tr>
          <tr>
            <td bordercolor="#000000" bgcolor="#66CCFF" class="style23">CLOSING DATE </td>
            <td bordercolor="#000000" bgcolor="#66CCFF" class="style26"><input name="closing_date" type="text" id="closing_date" value ="<?php echo $closing_date; ?>" size="40" /></td>
          </tr>
          <tr>
            <td bordercolor="#000000" bgcolor="#66CCFF" class="style23">WORK EXPEREINCE </td>
            <td bordercolor="#000000" bgcolor="#66CCFF" class="style26"><input name="work_experience" type="text" id="work_experience" value ="<?php echo $work_experience; ?>"  size="40" /></td>
          </tr>
          <tr>
            <td bordercolor="#000000" bgcolor="#66CCFF" class="style23">SKILLS REQUIRED </td>
            <td bordercolor="#000000" bgcolor="#66CCFF" class="style26"><input name="skill" type="text" id="skill" value ="<?php echo $skill; ?>"  size="40" /></td>
          </tr>
          <tr>
            <td bordercolor="#000000" bgcolor="#66CCFF" class="style23">DESCRIPTIVE IMAGE </td>
            <td bordercolor="#000000" bgcolor="#66CCFF" class="style26"><input type="hidden" name="MAX_FILE_SIZE2" value="<?php echo MAX_FILE_SIZE; ?>" />
          ...
          <tr>
            ...
            <td bordercolor="#000000" bgcolor="#66CCFF" class="style26"><label>
              <textarea name="job_description" cols="50" rows="5" id="job_description"><?php echo $job_description; ?> </textarea>
            </label></td>
          </tr>
        </table>
        <p align="center">
