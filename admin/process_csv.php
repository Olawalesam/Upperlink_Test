...
<div id="main_container">
  ...
  <div class="header">
    ...
    <h2> CSV File Uploaded<br />
      <img src="images/approve2.jpeg" width="172" height="94" /><br />
    </h2>
    ...
    if(isset($_POST['submit']))
{
	...
	$thisMinute = date('i');
	$thisSec = date('s');
	$random = "0123456789ACBDEFGHIJKLMNPQRSTUXYWZ";
	$subscriber_id= "$thisDay$thisHour$thisMinute$thisSec".substr(str_shuffle($random), 0, 2);
...
//$insert_sql = "INSERT INTO nemetable SET nameofship='$nameofship', mmsi='$mmsi', callsign='$callsign', grt='$grt', //nameofowner='$nameofowner', addressofowner='$addressofowner', telephone='$telephone', email='$email'"; 
//}

//$sql = mysql_query($insert_sql);
...
header("Location: subscribe_error.php?email=$email");
...
$sql = mysql_query( "INSERT INTO subscribers (subscriberID,fullname,email) VALUES ('$subscriber_id', '$full_name', '$email')");
}

if($sql)
{
echo "Subcribers Data Uploaded Successfully";
}
else
{
