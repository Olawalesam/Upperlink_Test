...
<div id="main_container">
  ...
  <div class="header">
    ...
    <div class="right_content">            
      ...
      <h2 align="center"><span class="style26">UPLOAD NEWS/EVENTS</span></h2>
      <center>
        <form action="" method="post" enctype="multipart/form-data" name="uploadImage" id="uploadImage">
          <p><a href="managenews.php">[Back To Manage News]</a></p>
          <table width="600" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#999999" bgcolor="#6699FF">
            <tr bgcolor="#EFEFEF">
              <td colspan="2" bordercolor="#000000" bgcolor="#66CCFF" class="style20"><div align="center" class="style21 style22">FILL THE NEWS DETAILS </div></td>
            </tr>
            <tr>
            ...
            <tr>
              <td bordercolor="#000000" bgcolor="#66CCFF" class="style23">NEWS HEADLINE </td>
            ...
            <tr>
              <td bordercolor="#000000" bgcolor="#66CCFF" class="style23">COVER PHOTO FOR NEWS </td>
            ...
            <tr>
              <td bordercolor="#000000" bgcolor="#66CCFF" class="style23">NEWS STORY CONTENT </td>
              <td bordercolor="#000000" bgcolor="#66CCFF" class="style27"><label>
                <textarea name="storycontent" cols="50" rows="5" id="storycontent"></textarea>
              </label></td>
            </tr>
          </table>
          <p>
