...
<div id="main_container">
  ...
  <div class="header">
    ...
    <h2> View Subscribers <br />
      <br />
      <a href="upload_csv.php">[Upload Subscribers From CSV File]</a></h2>
...
?>
    ...
    <p align="center"><table width="585" border="1" cellpadding="0" cellspacing="0"> 
                <thead> 
                    <tr> 
                        <th width="48" height="18">S/N</th> 
                        <th width="223">Fullname</th> 
				...
				?>
                    <tr> 
                        ...
                        <td width="268"><?php echo $recs['email']; ?></td>
                        <td width="36"><div align="center"><a href="../scripts/delete.php?ident=<?php echo $recs['id']; ?>" onclick="return confirm('Delete this Subscriber?');"><img src="images/wrong_32x32.png" width="20" height="20"></a></div></td>
                    </tr> 
                    <?php } ?>
