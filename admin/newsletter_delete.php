...
if ($_GET && !$_POST) {
  ...
  if ($delete_id) {
    $sql = "SELECT * FROM letters WHERE id = $delete_id";
...
<div id="main_container">
  ...
  <div class="header">
    ...
    <div class="right_content">            
      ...
      <h1 align="center" class=" style8 style26 style28">Newsletter Entries </h1>
      <div align="center">
        <?php if (!isset($delete_id) || empty($row)) { ?>
      </div>
      <p align="center" class="warning style8 style27">Invalid request: record does not exist.</p>
      <div align="center">
        <?php } 
else {
?>
      </div>
      <p align="center" class="warning style8 style10">Please confirm that you want to delete the following item. This action cannot be undone.</p>
      <div align="center">
        <table width="250" border="1" align="center">
          <tr bgcolor="blue">
            <td bgcolor="#66CCFF"><div align="center"><span class="style17">Date Sent </span></div></td>
          </tr>
          <tr>
            <td bgcolor="#66CCFF"><?php echo htmlentities($row['sentday']); ?></td>
          </tr>
        </table>
        <?php } ?>
      </div>
