    ...
    <div class="right_content">            
      ...
      <div align="center">
        <p><a href="createadmin.php"><br />
          </a><span class="style24">Administrators With Login Details</span>
          <?php if ((!isset($_GET['p']))  && (!isset($_GET['deleteid'])) && (!isset($_GET['deleted']))) { ?>
          <br />
        </p>
      </div>
      <center>
        <table width="462" border="0" bordercolor="#993333" bgcolor="#000000">
          <tr>
            <td bgcolor="#6699CC" class="style17">User Name</td>
            <td bgcolor="#6699CC" class="style14 style22">Password</td>
            <td bgcolor="#6699CC" class="style17">Action</td>
          </tr>
          <?php do { ?>
          <tr>
            <td bgcolor="#66CCCC" class="style25"><?php echo '<font color="white">' . $row_proven['username'] .'</font>' ; ?></td>
            <td bgcolor="#66CCCC" class="style25"><?php echo '<font color="white">' . $row_proven['password'] .'</font>'; ?></td>
            <td bgcolor="#66CCCC" class="style25"><a href="account_admin_delete.php?deleteid=<?php echo $row_proven['id']; ?>">Delete</a></td>
          </tr>
          <?php } while ($row_proven = mysql_fetch_assoc($proven)); ?>
        </table>
      </center>
      <?php } else if (isset($_GET['deleted'])) {?>
      <span class="style25">Admin details deleted successfully.</span>
      <?php } ?>
      </p>
      <h2 align="center"></h2>
      <p align="center"></p>
