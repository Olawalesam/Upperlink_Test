...
if ((isset($_GET['deleteid'])) && ($_GET['deleteid'] != "")) {
  $deleteSQL = sprintf("DELETE FROM letters WHERE id=%s",
  ...
  $deleteGoTo = "proven_admin.php?deleted";
...
mysql_select_db($database_proven, $proven);
$query_proven = "SELECT * FROM letters";
  ...
  <div class="header">
    ...
    <div class="left_content">
        ...
        <div class="sidebarmenu">
                   ...
                   <div class="submenu">
                    <ul>
                    <li><a href="proven_admin.php"><img src="images/view.jpg" width="20" height="20" align="absmiddle" />View  Admin User proven </a></li>
                    <li><a href="createadmin.php"><img src="images/create.jpeg" width="20" height="20" align="absmiddle" />Create Admin User </a></li>
                    <li><a href="proven_admin.php"><img src="images/delete2.jpg" width="20" height="20" align="absmiddle" />Delete Admin User Acount </a></li>
                  </ul>
          </div>
    ...
    <div align="center">
      <p><?php if ((!isset($_GET['p']))  && (!isset($_GET['deleteid'])) && (!isset($_GET['deleted']))) { ?>
          <br />
      </p>
    </div>
    <center>
      <table width="462" border="0" bordercolor="#993333" bgcolor="#000000">
        <tr>
          <td bgcolor="#6699CC" class="style17">Date Sent </td>
		  <td bgcolor="#6699CC" class="style17">Message</td>
		    <td bgcolor="#6699CC" class="style17">Total Recipients </td>
          <td bgcolor="#6699CC" class="style17">Action</td>
        </tr>
        <?php do { ?>
        <tr>
          <td bgcolor="#66CCCC" class="style25"><?php echo '<font color="white">' . $row_proven['sentday'] .'</font>'; ?></td>
		  <td bgcolor="#66CCCC" class="style25"><?php 
		 
		  $the_message = $row_proven['message'] ;
		 
		$the_message = substr($the_message,0,50) ;
		  
		  
		  echo '<font color="white">' . $the_message .'</font>'; ?><a href="message_full.php?fullid=<?php echo $row_proven['id']; ?>">View in Full</a></td>
		  <td bgcolor="#66CCCC" class="style25"><?php echo '<font color="white">' . $row_proven['totalrecipients'] .'</font>'; ?></td>
          <td bgcolor="#66CCCC" class="style25"><a href="newsletter_delete.php?deleteid=<?php echo $row_proven['id']; ?>">Delete</a></td>
        </tr>
        <?php } while ($row_proven = mysql_fetch_assoc($proven)); ?>
      </table>
    </center>
    <?php } else if (isset($_GET['deleted'])) {?>
    <span class="style25">Newsletters details deleted successfully.</span>
    <?php } ?>
    </p>
    <h2 align="center"></h2>
    <p>&nbsp;</p>
