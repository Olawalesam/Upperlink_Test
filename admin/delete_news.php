...
<div id="main_container">
  ...
  <div class="header">
    ...
    <div class="right_content">            
      ...
      <h2 align="center">Delete News Section
        </p>
</h2>
      <div align="center">
        <?php
...
$ok1 = @mysql_query("DELETE FROM postnews WHERE id='$id'"); 

if ($ok1) {
  echo '<p><center><font color="red">News deleted successfully!</font></center></p>';
} else {
  echo '<p>Error deleting news from database!<br />'.
       'Error: ' . mysql_error() . '</p>';
}
