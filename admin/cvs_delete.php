...
if (($action == 'view' or $action == 'dnld') and isset($_GET['id'])) {
  ...
  $sql = "SELECT filename, mimetype, filedata
      FROM postcv WHERE id = '$id' ORDER BY id DESC";
  ...
  $sql = "DELETE FROM postcv WHERE id = '$id'";
  $ok = @mysql_query($sql);
  if (!$ok) {
    exit('Database error: ' . mysql_error());
  }
...
$sql = "SELECT * FROM postcv ORDER BY id DESC LIMIT $startrow, 10";
...
<div id="main_container">
  ...
  <div class="header">
    ...
    <div class="right_content">            
      ...
      <h2 align="center">View Submitted Contacts Section</h2>
      <p align="center" class="style21 style13 style23 style24"><strong>Current Contacts </strong><br />
          <br />
      </p>
...
?>
	  ...
	  <table width="606" border="2" bordercolor="#000000">
          <tr>
            <th width="61" bgcolor="#6699CC"><span class="style26">Submission Date </span></th>
            <th width="52" bgcolor="#6699CC"><span class="style26">Full Name</span></th>
            <th width="46" bgcolor="#6699CC"><span class="style26">Address</span></th>
            <th width="61" bgcolor="#6699CC"><span class="style26">Email</span></th>
            <th width="61" bgcolor="#6699CC"><span class="style26">Phone</span></th>
            <th width="91" bgcolor="#6699CC"><span class="style26">Click To View/Download </span></th>
			<th width="237" bgcolor="#6699CC"><span class="style26">Action</span></th>
          </tr>
          <?php
  ...
  while ($f = mysql_fetch_array($filelist)) {
    ?>
          <tr valign="top" bgcolor="#CCCCCC">
            ...
            <td bgcolor="#66CCFF"><?php echo $f['full_name']; ?> </td>
			...
			<td bgcolor="#66CCFF"> [<a href="<?php echo $_SERVER['PHP_SELF']; ?>?action=del&amp;id=<?php echo $f['id']; ?>"
